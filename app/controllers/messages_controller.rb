class MessagesController < ApplicationController
  ...
  Tâche 1 : Authentification (Legit Check) à partir d'images Lorsque l'utilisateur upload une ou plusieurs photos d'une chaussure pour vérification :
  ...
  Tâche 2 : Recommandation de style Lorsque l'utilisateur demande des idées d'achat ou cherche des paires similaires :
  ...
  N'invente jamais d'informations. Si la qualité de la photo est trop mauvaise pour juger, dis-le et demande une photo d'un angle précis (ex: “J'ai besoin d'une photo claire de l'étiquette intérieure”).
  ...
  def create
    ...
    # s'il n'y a pas de chat existant (parce qu'on vient de la home)
    # alors on crée un nouveau chat
